...
C***BEGIN PROLOGUE  ZZABS
C***REFER TO  ZBESH,ZBESI,ZBESJ,ZBESK,ZBESY,ZAIRY,ZBIRY
C
C     ZZABS COMPUTES THE ABSOLUTE VALUE OR MAGNITUDE OF A DOUBLE
C     PRECISION COMPLEX VARIABLE CMPLX(ZR,ZI)
C
C***ROUTINES CALLED  (NONE)
C***END PROLOGUE  ZZABS
...
C-----------------------------------------------------------------------
      ...
      IF (U.GT.V) GO TO 10
      Q = U/V
      ZZABS = V*DSQRT(1.D+0+Q*Q)
      RETURN
   10 Q = V/U
      ZZABS = U*DSQRT(1.D+0+Q*Q)
      RETURN
   20 ZZABS = 0.0D+0
      RETURN
      END
...
C
C***ROUTINES CALLED  ZASYI,ZBKNU,ZMLRI,ZSERI,ZS1S2,D1MACH,ZZABS
...
C     COMPLEX CSGN,CSPN,C1,C2,Y,Z,ZN,CY
     ...
     * RL, SGN, TOL, YY, YR, YI, ZR, ZI, ZNR, ZNI, D1MACH, ZZABS
...
C     COMPLEX AI,CONE,CSQ,CY,S1,S2,TRM1,TRM2,Z,ZTA,Z3
     ...
     * ZEROR, ZI, ZR, ZTAI, ZTAR, Z3I, Z3R, D1MACH, ZZABS, ALAZ, BB
...
C
C***ROUTINES CALLED  D1MACH,ZZABS,ZDIV,ZEXP,ZMLT,ZSQRT
...
C     COMPLEX AK1,CK,CONE,CS1,CS2,CZ,CZERO,DK,EZ,P1,RZ,S2,Y,Z
     ...
     * S2R, TOL, TZI, TZR, YI, YR, ZEROI, ZEROR, ZI, ZR, D1MACH, ZZABS
...
C     COMPLEX CONE,CSGN,CW,CY,CZERO,Z,ZN
     ...
     * ZR, D1MACH, AZ, BB, FN, ZZABS, ASCLE, RTOL, ATOL, STI
...
C
C***ROUTINES CALLED  ZZABS,ZASYI,ZBUNI,ZMLRI,ZSERI,ZUOIK,ZWRSK
C***END PROLOGUE  ZBINU
      DOUBLE PRECISION ALIM, AZ, CWI, CWR, CYI, CYR, DFNU, ELIM, FNU,
     * FNUL, RL, TOL, ZEROI, ZEROR, ZI, ZR, ZZABS
...
C
C***ROUTINES CALLED  DGAMLN,I1MACH,D1MACH,ZKSCL,ZSHCH,ZUCHK,ZZABS,ZDIV,
...
C
     ...
     * TOL, TTH, T1, T2, YI, YR, ZI, ZR, DGAMLN, D1MACH, ZZABS, ELM,
...
C
C***ROUTINES CALLED  ZUNI1,ZUNI2,ZZABS,D1MACH
...
C     COMPLEX CSCL,CSCR,CY,RZ,ST,S1,S2,Y,Z
     ...
     * S2I, S2R, TOL, YI, YR, ZI, ZR, ZZABS, ASCLE, BRY, C1R, C1I, C1M,
     * D1MACH
...
C
C***ROUTINES CALLED  ZUCHK,ZZABS,ZLOG
...
C     COMPLEX CK,CS,CY,CZERO,RZ,S1,S2,Y,ZR,ZD,CELM
     ...
     * S2R, TOL, YI, YR, ZEROI, ZEROR, ZRI, ZRR, ZZABS,
...
C
C***ROUTINES CALLED  DGAMLN,D1MACH,ZZABS,ZEXP,ZLOG,ZMLT
...
C     COMPLEX Z,CY(1),CONE,CZERO,P1,P2,T1,RZ,PT,CDFNU
     ...
     * RZR, TEST, TEST1, TOL, TTI, TTR, T1I, T1R, ZI, ZR, ZZABS
...
C
C***ROUTINES CALLED  DGAMLN,D1MACH,ZUCHK,ZZABS,ZDIV,ZLOG,ZMLT
...
C-----------------------------------------------------------------------
      ...
      DO 130 L=3,NN
        ...
        AK = AK - 1.0D0
        K = K - 1
        IF (ZZABS(CKR,CKI).GT.ASCLE) GO TO 140
  130 CONTINUE
      RETURN
  140 CONTINUE
      IB = L + 1
...
C
C***ROUTINES CALLED  ZZABS,ZDIV,ZLOG,ZSQRT,D1MACH
...
C    *ZETA2,ZTH
     ...
     * ZETA2R, ZI, ZR, ZTHI, ZTHR, ZZABS, AC, D1MACH
...
C
C***ROUTINES CALLED  ZUCHK,ZUNIK,ZUOIK,D1MACH,ZZABS
...
C    *S2,Y,Z,ZETA1,ZETA2
     ...
     * ZETA1R, ZETA2I, ZETA2R, ZI, ZR, CYR, CYI, D1MACH, ZZABS
...
C     Y(I)=CZERO FOR I=NLAST+1,N
C
C***ROUTINES CALLED  ZAIRY,ZUCHK,ZUNHJ,ZUOIK,D1MACH,ZZABS
...
C             ANOTHER ROUTINE
C
C***ROUTINES CALLED  ZUCHK,ZUNHJ,ZUNIK,D1MACH,ZZABS,ZLOG
...
C    *ZR
     ...
     * ZNI, ZNR, ZR, ZRI, ZRR, D1MACH, ZZABS
...
C
C***ROUTINES CALLED  D1MACH,ZBKNU,ZRATI,ZZABS
...
C     COMPLEX CINU,CSCL,CT,CW,C1,C2,RCT,ST,Y,ZR
     ...
     * STI, STR, TOL, YI, YR, ZRI, ZRR, ZZABS, D1MACH
